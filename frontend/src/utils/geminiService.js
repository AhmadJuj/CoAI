 ...
 * @param {Object} existingDocument - Optional existing document to improve
 * @returns {Promise<string>} Generated/improved document content
 */
...
Please provide the improved document content in HTML format, preserving the existing HTML structure.`;
    ...
    throw new Error('Failed to improve document. Please check your API key and try again.');
  }
}
